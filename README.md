...
Коротко: SubTrack — трекер подписок на Expo/React Native. Демо-проект курса «Вайбкодинг: мобильное приложение за 3 недели».

## Что здесь

- Назначение: SubTrack — трекер подписок на Expo/React Native. Демо-проект курса «Вайбкодинг: мобильное приложение за 3 недели».
