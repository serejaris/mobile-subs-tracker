...
На уроке 3 ты генерировал структуру онбординга в ChatGPT / Gemini / Claude — экраны, тексты кнопок, варианты ответов квиза. Этот текст называется «артефакт». Можно вставить его целиком в Stitch вместо трёх строк — дизайн будет точнее, потому что Stitch увидит все детали.
